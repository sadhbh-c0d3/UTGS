...
namespace GVM {
    ...
    Message BindTextureMsg( int target, int index )
    {
    ...
    template< class _CBType > Message CallbackMsg( const _CBType &cb )
    {
        ...
        size_t numSlices = cbSize / sizeof( Message::data_t ) + (0 != cbSize % sizeof( Message::data_t ));
